...
const BottomBanner = () => {
  return (
    <div className='relative mt-24'>
      <img src={assets.bottom_banner_image} alt="bannner" 
      className='w-full hidden md:block'/>
        <img src={assets.bottom_banner_image_sm} alt="bannner" 
...
<div>
    ...
    {features.map((feature,index)=>(
       ...
       <p className='text-gray-500/70 text-xs '>{feature.description}</p>
        </div>
        </div>
    )
